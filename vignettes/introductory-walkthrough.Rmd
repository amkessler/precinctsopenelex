...
There are several ways to accomplish this, but we'll use the code below to capture all dataframes present in the global environment that contain the word `processed` in their names. 
